...
//         navigate(`/productinfo/${suggestion._id}`); // Navigate to the product details page
...
//     {suggestions.slice(0, 4).map((suggestion) => ( // Show only the first 4 suggestions
//       <li
//         key={suggestion._id}
...
//       </li>
//     ))}
//     {suggestions.length > 4 && ( // Show "See All Products" link if more than 4 suggestions
//       <li
