...
export default function UpdateProfile() {
  ...
  const validateForm = () => {
    ...
    if (!formData.email || typeof formData.email !== 'string' || !formData.email.trim() || !emailRegex.test(formData.email)) {
  ...
  return (
    <>
      ...
      <div className="max-w-md mx-auto my-4 p-6">
        <h2 className="text-xl font-semibold text-center mb-6">Profile Information</h2>
