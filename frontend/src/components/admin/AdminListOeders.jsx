...
//   const handleProductCancel = async (orderId, productId) => {
//     try {
//       const response = await axios.put(
...
//     setProductStatus(order.products.map(p => p.status || ''));// Pre-set the status for each product
//     setIsModalOpen(true);
//   };
...
//                   <span
//                     className={`inline-block px-2 py-1 text-xs font-semibold rounded-full ${order.orderStatus === 'Cancelled' ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800'}`}
//                   >
//                     {order.orderStatus}
//                   </span>
//                 </td>
...
//                   </button>
//                   <button
//                     onClick={() => handleProductCancel(order._id, productId)} // Cancel a specific product
...
//                     {/* Button to cancel individual product */}
//                     <button
//                       onClick={() => handleProductCancel(orderToEdit._id, product.productId)}
//                       className="text-red-600 hover:text-red-800"
//                     >
//                       <Trash2 className="w-5 h-5" />
//                     </button>
...
//                 </button>
//                 <button
//                   onClick={() => handleProductCancel(orderToEdit._id, productId)}
